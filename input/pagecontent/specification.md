...
The [InformationOrigin extension](StructureDefinition-information-origin.html) is intended for inclusion on each answer to identify the origin of the information - auto-populated, auto-populated and overridden, and manually entered.  (If the origin source is *auto-populated and overridden* or *manually entered*, then an information author **SHALL** be supplied). 
