...
* parameter[order].resource only $CRDAppointmentBase or $CRDEncounter or $CRDCommunicationRequest or $CRDDeviceRequest or ImmunizationRecommendation or $CRDMedicationRequest or $CRDNutritionOrder or $CRDServiceRequest or SupplyRequest or $CRDVisionPrescription
