...
// * parameter[order].resource only Appointment or $CRDCommunicationRequest or $CRDDeviceRequest or ImmunizationRecommendation or $CRDMedicationRequest or $CRDNutritionOrder or $CRDServiceRequest or SupplyRequest or $CRDVisionPrescription
...
// * parameter[Outcome].value[x] 0..1 MS
// * parameter[Outcome].value[x] only OperationOutcome
